...
function RawView(
  ...
  handleFileSelection: (filename: string, selected: boolean) => void,
  provider: string,
  openTabs: string[],
  activeTab: string | null,
  setActiveTab: React.Dispatch<React.SetStateAction<string | null>>,
  closeTab: (filename: string, e?: React.MouseEvent) => void,
  activeTabContent: CodeStructBlock | null,
  updateContentBlock: (filename: string, newContent: string) => void,
) {
  return (
